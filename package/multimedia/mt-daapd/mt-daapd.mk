...
MT_DAAPD_SITE = http://libexif.sourceforge.net/ FIXME
...
#$(MT_DAAPD_HOOK_POST_INSTALL):
#	cp $(MT_DAAPD_DIR)/contrib/mt-daapd.conf \
#		$(MT_DAAPD_DIR)/contrib/mt-daapd.playlist $(TARGET_DIR)/etc
#	touch $@