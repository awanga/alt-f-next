...
NTFSPROGS_DEPENDENCIES = libfuse # needed only for ntfsmount

# FIXME -- write ntfsmount rules, such that dependency (libfuse) is
# only used when ntfsmount is selected, as well as the binary and install step

NTFSPROGS_BIN:=ntfscat ntfscluster ntfscmp ntfsfix ntfsinfo ntfsls ntfsmount
...
$(NTFSPROGS_TARGET_INSTALL_TARGET): $(NTFSPROGS_TARGET_INSTALL_STAGING)
	...
	ln -sf /usr/sbin/mkntfs $(TARGET_DIR)/sbin/mkfs.ntfs
	touch $@
