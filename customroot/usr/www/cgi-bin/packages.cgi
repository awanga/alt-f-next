...
EOF
	...
	echo "<h4 align=center> <font color=red> Warning: configuration files are
	...
	echo "<form action="/cgi-bin/packages_proc.cgi" method=post>"
	
	echo "<h3>Installed Packages</h3><table>"
	...
	echo "<h3><a href="http://www.inreto.de/dns323/fun-plug/0.5/">FFP Available Packages</a></h3><table>"
