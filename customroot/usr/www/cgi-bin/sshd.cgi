...
cat<<-EOF
	...
	<td>22<input type=radio name=sshd_port id="sshd_22" $SSHD_22 value="22" onclick="toogle(this)"></td>
	<td>2222<input type=radio name=sshd_port id="sshd_2222" $SSHD_2222 value="2222" onclick="toogle(this)"></td>
	</tr></table>
	</fieldset><br>
EOF
